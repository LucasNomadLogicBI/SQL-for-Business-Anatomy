...
3. **Filtrado de Nulos (`IS NOT NULL`)**:
   - Aprendimos a limpiar reportes eliminando filas que no aportan información geográfica o categórica relevante.

### Dataset Utilizado:
- **Crunchbase**: Datos reales de startups, financiamiento y adquisiciones corporativas.
